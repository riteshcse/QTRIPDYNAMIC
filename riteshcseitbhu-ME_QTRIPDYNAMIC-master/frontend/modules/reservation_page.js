...
async function fetchReservations() {
  ...
  try {
    let res = await fetch(config.backendEndpoint + `/reservationsnpm`)
  ...
  console.log(reservations)
   if (reservations && reservations.length) {
    ...
    reservations.forEach( res=> {
      ...
      <td> <button class ="reservation-visit-button" id= "${res.id}"><a href="../detail/?adventure=${res.adventure}">view Adventure</a></button> </td>
      `
